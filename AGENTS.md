...
- `minecraft:coal_ore`, `minecraft:deepslate_coal_ore` ->
  `tfc:ore/normal_lignite`, fallback は `tfc:ore/normal_bituminous_coal`
- `minecraft:iron_ore`, `minecraft:deepslate_iron_ore` ->
  `tfc:ore/normal_hematite`, fallback は `tfc:ore/normal_magnetite`,
  さらに fallback は `tfc:ore/normal_limonite`
- `minecraft:copper_ore`, `minecraft:deepslate_copper_ore` ->
  `tfc:ore/normal_native_copper`
- `minecraft:gold_ore`, `minecraft:deepslate_gold_ore` ->
  `tfc:ore/normal_native_gold`
- `minecraft:nether_gold_ore` ->
  `tfc:ore/normal_nether_gold`, fallback は `tfc:ore/normal_native_gold`
- `minecraft:lapis_ore`, `minecraft:deepslate_lapis_ore` ->
  `tfc:ore/normal_lapis_lazuli`
- `minecraft:diamond_ore`, `minecraft:deepslate_diamond_ore` ->
  `tfc:ore/normal_diamond`
- `minecraft:emerald_ore`, `minecraft:deepslate_emerald_ore` ->
  `tfc:ore/normal_emerald`
- `minecraft:redstone_ore`, `minecraft:deepslate_redstone_ore` ->
  `tfc:ore/normal_cinnabar`
- `minecraft:nether_quartz_ore` -> `tfc:ore/normal_quartz`
